...
# name_alias - (Optional) Name name_alias for L3out HSRP interface group object.
...
# name_alias - (Optional) Name name_alias for object L3-out HSRP interface profile.
...
# name_alias - (Optional) Name name_alias for object L3out HSRP Secondary VIP.