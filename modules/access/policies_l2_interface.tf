...
variable "policies_l2_interface" {
  ...
  description = <<-EOT
    ...
    * qinq: (optional) —  To enable or disable an interface for Dot1q Tunnel or Q-in-Q encapsulation modes, select one of the following:
    ...
    * reflective_relay: (optional) — Enable or disable reflective relay for ports that consume the policy.
      - disabled: (default)
      - enabled
    * vlan_scope: (optional) — The layer 2 interface VLAN scope. The scope can be:
